...
contract StudentFactory {
    ...
    event StudentCreated(address indexed eventCaller, address studentAddress, string name, uint256 age, string course, address account);
    event StudentDeleted(address indexed eventCaller, address studentAddress);
    event TeacherAssigned(address indexed eventCaller, address studentAddress, address teacherAddress);
    ...
    function createStudent(
        ...
        emit StudentCreated(msg.sender, address(newStudent), _name, _age, _course, _account);
    }
